...
const biomas = [
    {
        ...
        comportamento: "Criaturas geralmente pacíficas durante o dia, com comportamento defensivo coordenado quando ameaçadas. Herbívoros pastam livremente em manadas, enquanto pequenos predadores caçam em bandos táticos. À noite, a dinâmica muda com predadores noturnos assumindo o controle.",
        recursos: ["Madeira básica", "Pedra abundante", "Flores medicinais", "Bagas nutritivas", "Fibra resistente"]
    },
    {
        id: 2,
        nome: "Planalto",
        ...
        descricaoCompleta: "Elevando-se acima dos campos mais quentes, o Planalto apresenta uma topografia única que mescla solo plano com morros suaves e vales escondidos. Sua vegetação é um híbrido fascinante entre plantas de altitude e espécies das terras baixas. Arbustos resistentes se entrelaçam com pequenas árvores retorcidas pelo vento e um arboreto leve que permite passagem estratégica. Cavernas esculpidas pela erosão milenar e tocas naturais oferecem abrigo crucial para criaturas noturnas ou aquelas que preferem a meia-luz protetora. A proximidade estratégica com praias ou campos torna essa zona ideal para acampamentos, mas os moradores nativos sabem que a tranquilidade aparente é enganosa: emboscadas à noite são comuns e mortais. Aqui a caça exige paciência suprema: as presas formam grupos de alerta sofisticados, e os predadores surgem silenciosamente das sombras como fantasmas. Construir vilas ou postos de vigia é mais seguro, mas ainda exige respeito absoluto ao terreno traiçoeiro e à noite que se fecha rapidamente, engolindo a paisagem em escuridão profunda.",
        vegetacao: [
        ...
        comportamento: "Animais adaptados a condições mais rigorosas de vento e temperatura. Predadores são extremamente territoriais e caçam em emboscadas coordenadas. Herbívoros formam manadas defensivas compactas para proteção mútua contra ameaças aéreas e terrestres.",
        recursos: ["Metal de qualidade média", "Pedra para construção", "Cristal semi-transparente", "Peles grossas para armadura", "Quitina de insetos resistentes"]
    },
    {
        id: 3,
        nome: "Montanha",
    ...
    },
    {
        ...
        comportamento: "Equilíbrio dinâmico entre predadores especializados e presas adaptadas. Bandos de pequenos predadores caçam com táticas coordenadas, enquanto herbívoros solitários desenvolveram mecanismos de defesa únicos. Comportamentos territoriais moderados que se intensificam durante estações de acasalamento.",
        recursos: ["Madeira diversa para todos os tipos de construção", "Frutos silvestres com diferentes valores nutricionais", "Sementes raras para cultivo especializado", "Fibra abundante para cordas e tecidos", "Plantas com propriedades medicinais e alucinógenas"]
    },
    {
        id: 6,
        nome: "Caverna",
        ...
        recursos: ["Cristal de caverna com pureza excepcional", "Pérolas luminosas para iluminação avançada", "Artefatos antigos de tecnologia perdida", "Recursos aberrantes com propriedades únicas", "Minérios raros formados em condições extremas"]
    },
    {
        id: 7,
        nome: "Praia",
        ...
        recursos: ["Silica pearls para componentes eletrônicos", "Oil nodes para combustível e iluminação", "Chitin marinha para armaduras leves", "Sand para construção e vidro", "Salt para preservação de alimentos e química"]
    },
    {
        id: 8,
        nome: "Deserto",
        ...
        descricaoCompleta: "O Deserto é um oceano de areia movediça sob um sol inclemente que castiga sem piedade. Poucas árvores sobrevivem neste ambiente hostil, e os ventos quentes carregam partículas abrasivas que desgastam até a rocha mais dura. Os predadores que prosperam aqui são mestres da furtividade, adaptados à sede constante e ao calor opressivo através de mecanismos fisiológicos extraordinários. Poços de água ocultos são santuários vitais neste mar de aridez - locais intensamente protegidos por seus guardiões, ferozmente disputados por todos os seres do deserto, e absolutamente vitais para qualquer forma de vida que ouse desafiar este ambiente extremo. A sobrevivência no Deserto não é uma questão de força, mas de inteligência, paciência e conhecimento dos segredos que a areia esconde.",
        vegetacao: [
        ...
        comportamento: "Criaturas de hábitos predominantemente noturnos ou crepusculares para evitar o calor diurno. Comportamentos de conservação de água e energia extremos. Predadores especializados em emboscadas a partir de tocas subterrâneas ou camuflagem na areia.",
        recursos: ["Cristal do deserto com pureza excepcional", "Salitre para explosivos e conservantes", "Óleo de xisto em ve superficiais", "Peles leves para proteção solar", "Areia especial para fabricação de vidro"]
    },
    {
        id: 9,
        nome: "Deserto Frio",
    ...
    },
    {
        ...
        recursos: ["Pelagens de inverno de qualidade superior", "Chifres especiais para ferramentas e armas", "Gordura animal para lampiões de longa duração", "Plantas medicinais adaptadas ao frio", "Minérios expostos pela erosão glacial"]
    },
    {
        id: 11,
    ...
    },
    {
        ...
        comportamento: "Criaturas suínas dominam a hierarquia do bioma através de força bruta e adaptação digestiva. Comportamentos especializados de busca por trufas raras e minérios específicos. Defesa agressiva e coordenada dos territórios de pastagem mais ricos em nutrientes.",
        recursos: ["Hypo minério para ligas metálicas avançadas", "Truffles raras com valor culinário e medicinal", "Mushroom spores para cultivo especializado", "Fungal wood com propriedades de autorregeneração", "Rare flowers para poções de efeitos únicos"]
    },
    {
        id: 13,
