...
const effects = [
    ...
    { name: "Certeiro", img: "imagens/icon_certeiro.jpg", description: "O alvo mira no inimigo e ganha +5 no ataque, ganahdo +1 dado de dano e examiando um ponto fraco ou de interesse por 1 rodada. (+ficha)" },
    { name: "Fraco", img: "imagens/icon_fraco.jpg", description: "O alvo sofre -1 for, -5 em testes de força ou vigor, causa menos dano físico, perdendo 2 dados de dano até o efeito acabar. (+ficha)" },
    ...
    { name: "Fadiga", img: "imagens/icon_fadiga.jpg", description: "O alvo sofre -1 agi ou -1 int, -5 em testes envolvendo int/agi, caso o fôlego esteja zerado fica com as desvatagens de sufocado(Sem ar)" },
    { name: "Molestado", img: "imagens/icon_molestado.jpg", description: "O alvo sofre +5 de ataques de inimgios conforme o número do grupo inimigo aumenta de forma eficiente, comparado ao grupo do alvo durante a cena. (+ficha)" },
    ...
    { name: "Revelado", img: "imagens/icon_revelado.jpg", description: "O alvo possui a aura revelada, sua presença ou localização mostrada para todos os inimigos na cena. (+ficha)" },
