...
const imagens = [
  ...
  { src: "imagens/Mark_morrendo.png", titulo:"Cenas de Chefe", texto: "Cenas de Chefe ocorrem quando um jogador ou o grupo enfrenta um inimigo de grande poder, alguém que eliminou ao menos um Colosso ou possui uma equipe e preparo além da tribo dos jogadores. Esses confrontos são marcantes e extremamente desafiadores. O primeiro encontro é sempre mortal, impondo limites às habilidades e mutações dos personagens, forçando-os a recuar ou lutar pela sobrevivência. Já no segundo confronto, a batalha se torna pessoal. O grupo se prepara com estratégias, aliados e novos poderes, transformando a luta em um embate temático e definitivo. Esse momento representa o auge do conflito, onde cada decisão pode significar a vitória ou a destruição. ", fundo: "imagens/Mark_morrendo.png" },
  { src: "imagens/regras_fundo15.jpg", titulo:"Cenas de Colosso", texto: "Cenas de Colosso ocorrem quando um jogador ou grupo enfrenta um Colosso em uma arena, onde apenas ataques, habilidades e itens com alteração arcana podem ser usados, desativando completamente as mutações. Falhas aumentam a dificuldade do combate, tornando o Colosso mais agressivo e resistente. Criaturas não o atacam naturalmente, a menos que a criatura passe em um teste de Intimidação para ser notado por ela. Além disso, impactos causam dano extra dobrado, tornando cada golpe decisivo. Essas batalhas representam o auge da brutalidade e exigem estratégia e domínio da arena para alcançar a vitória.", fundo: "imagens/regras_fundo15.jpg" },
  { src: "imagens/regras_fundo16.jpg", titulo:"Cenas de Luta Brutal", texto: "Cenas de luta brutal são aquelas em que os personagens se encontram presos em situações onde o único destino possível é a luta, enfrentando inimigos em masmorras ou emboscadas de equipe. Nessas batalhas, o grupo deve montar uma equipe para lutar pela salvação de todos, e sempre que o número de membros de uma equipe diminuir em relação à outra, o time inimigo tem uma rodada para tentar balancear as forças e evitar que a guarda seja quebrada até o fim da luta, ou que a derrota se torne certa. Essas lutas variam em situações, mas sempre envolvem rodadas focadas em mecânicas de efeitos, manobras ou doenças, com a maior iniciativa pertencendo ao ser mais distante. Antes da luta, todas as reações dos participantes são definidas, e eles serão desafiados a enfrentar esse banho de sangue.", fundo: "imagens/regras_fundo16.jpg" },
  { src: "imagens/regras_fundo17.jpg", titulo:"Cenas de Despertar", texto: "Cenas de Despertar são momentos em que o personagem atinge o ápice de sua adrenalina ou de uma situação crucial no Ark, onde ele precisa se tornar mais forte para sobreviver ou salvar o grupo. Geralmente, esses momentos envolvem um objetivo específico, como uma mutação ou uma nova maneira de perceber o mundo, a realidade e até os sentimentos. Ao despertar, o personagem libera uma passiva ou habilidade extra permanente, marcando essa transformação significativa em sua jornada.", fundo: "imagens/regras_fundo17.jpg" },
  { src: "imagens/regras_fundo18.jpg", titulo:"Cenas de Duelo em Arena", texto: "Cenas de Duelo em Arena ou Territorial são situações em que o grupo ou jogador decide marcar um confronto com uma criatura de alguma maneira, utilizando itens como um item de comunicação, invocação ou medalhão de duelo. Ao interagir com e usar esses itens, o grupo ou jogador é levado para uma arena, onde a criatura também será transportada. Durante a luta, nenhum participante pode fugir, e todos lutarão até o fim. O vencedor retornará à sua base com os espólios do inimigo, incluindo seus itens e tudo que tenha relação com o tema da criatura. O transporte para a arena é feito por células concentradas em coordenadas na ilha, que viajam à velocidade da luz, sem causar dor ou desconforto.", fundo: "imagens/regras_fundo18.jpg" },
];
